...
export namespace MobileDeviceResource {
    export type NotificationPlatformEnum = 'APNS' | 'GCM';
    export const NotificationPlatformEnum = {
        APNS: 'APNS' as NotificationPlatformEnum,
        GCM: 'GCM' as NotificationPlatformEnum
    };
}
