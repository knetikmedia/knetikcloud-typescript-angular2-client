...
export interface InventorySubscriptionResource { 
     ...
     */
    readonly creditLog?: Array<SubscriptionCreditResource>;
    /**
...
export namespace InventorySubscriptionResource {
    export type InventoryStatusEnum = 'pending' | 'active' | 'inactive';
    export const InventoryStatusEnum = {
        Pending: 'pending' as InventoryStatusEnum,
        Active: 'active' as InventoryStatusEnum,
        Inactive: 'inactive' as InventoryStatusEnum
    };
}
