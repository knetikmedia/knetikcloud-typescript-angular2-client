...
export namespace CouponItem {
    export type CouponTypeHintEnum = 'coupon_cart' | 'coupon_single_item' | 'coupon_voucher' | 'coupon_vendor' | 'coupon_tag';
    export const CouponTypeHintEnum = {
        Cart: 'coupon_cart' as CouponTypeHintEnum,
        SingleItem: 'coupon_single_item' as CouponTypeHintEnum,
        Voucher: 'coupon_voucher' as CouponTypeHintEnum,
        Vendor: 'coupon_vendor' as CouponTypeHintEnum,
        Tag: 'coupon_tag' as CouponTypeHintEnum
    };
