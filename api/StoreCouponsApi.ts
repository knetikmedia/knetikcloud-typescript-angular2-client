...
export class StoreCouponsApi {
     ...
     */
    public createCouponItem(couponItem?: models.CouponItem, extraHttpRequestParams?: any): Observable<models.CouponItem> {
        return this.createCouponItemWithHttpInfo(couponItem, extraHttpRequestParams)
     ...
     * @param couponItem The coupon item object
     */
    public updateCouponItem(id: number, couponItem?: models.CouponItem, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateCouponItemWithHttpInfo(id, couponItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateCouponTemplate(id: string, couponTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param couponItem The coupon item object
     */
    public createCouponItemWithHttpInfo(couponItem?: models.CouponItem, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param couponItem The coupon item object
     */
    public updateCouponItemWithHttpInfo(id: number, couponItem?: models.CouponItem, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/store/coupons/${id}`;
