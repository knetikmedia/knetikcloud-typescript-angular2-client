...
export class StoreShoppingCartsApi {
     ...
     * @param id The id of the cart
     */
    public getCountries(id: string, extraHttpRequestParams?: any): Observable<models.SampleCountriesResponse> {
        return this.getCountriesWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
    ...
    public createCartWithHttpInfo(owner?: number, currencyCode?: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        if (owner !== undefined) {
            if(owner instanceof Date) {
                queryParameters.set('owner', <any>owner.d.toISOString());
            } else {
        ...
        if (currencyCode !== undefined) {
            if(currencyCode instanceof Date) {
                queryParameters.set('currency_code', <any>currencyCode.d.toISOString());
            } else {
    ...
    public getCartsWithHttpInfo(filterOwnerId?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (filterOwnerId !== undefined) {
            if(filterOwnerId instanceof Date) {
                queryParameters.set('filter_owner_id', <any>filterOwnerId.d.toISOString());
            } else {
     ...
     * @param id The id of the cart
     */
    public getCountriesWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
