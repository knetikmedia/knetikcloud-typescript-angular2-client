...
export class GamificationLevelingApi {
     ...
     */
    public getLevelsUsingGET(filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageLevelingResource> {
     ...
     * @param userId The id of the user
     */
    public getUserLevelsUsingGET(userId: number, extraHttpRequestParams?: any): Observable<models.PageUserLevelingResource> {
