...
export class GamificationLevelingApi {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getUserLevels(userId: number, filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceUserLevelingResource> {
     ...
     */
    public incrementProgress(userId: number, name: string, progress?: number, extraHttpRequestParams?: any): Observable<{}> {
     ...
     */
    public setProgress(userId: number, name: string, progress?: number, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getUserLevelsWithHttpInfo(userId: number, filterName?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param progress The amount of progress to add
     */
    public incrementProgressWithHttpInfo(userId: number, name: string, progress?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param progress The new progress amount
     */
    public setProgressWithHttpInfo(userId: number, name: string, progress?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/users/${user_id}/leveling/${name}/progress'
                    .replace('${' + 'user_id' + '}', String(userId))
                    .replace('${' + 'name' + '}', String(name));
