...
export class ReportingOrdersApi {
     ...
     */
    public getDailyInvoicesUsingGET(currencyCode: string, granularity?: string, filterPaymentStatus?: string, filterFulfillmentStatus?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any): Observable<models.PageAggregateInvoiceReportResource> {
