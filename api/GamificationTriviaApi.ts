...
export class GamificationTriviaApi {
     ...
     */
    public getQuestionTags1(filterSearch?: string, filterCategory?: string, filterImportId?: number, extraHttpRequestParams?: any): Observable<models.Collectionstring> {
        return this.getQuestionTags1WithHttpInfo(filterSearch, filterCategory, filterImportId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param filterImportId Filter for questions from a specific import job
     */
    public getQuestions(size?: number, page?: number, order?: string, filterSearch?: string, filterIdset?: string, filterCategory?: string, filterTagset?: string, filterType?: string, filterPublished?: boolean, filterImportId?: number, extraHttpRequestParams?: any): Observable<models.PageResourceQuestionResource> {
        return this.getQuestionsWithHttpInfo(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param questionTemplateResource The question template resource object
     */
    public updateQuestionTemplate(id: string, questionTemplateResource?: models.QuestionTemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param filterImportId Filter for tags on questions from a specific import job
     */
    public getQuestionTags1WithHttpInfo(filterSearch?: string, filterCategory?: string, filterImportId?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param filterImportId Filter for questions from a specific import job
     */
    public getQuestionsWithHttpInfo(size?: number, page?: number, order?: string, filterSearch?: string, filterIdset?: string, filterCategory?: string, filterTagset?: string, filterType?: string, filterPublished?: boolean, filterImportId?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/trivia/questions`;
