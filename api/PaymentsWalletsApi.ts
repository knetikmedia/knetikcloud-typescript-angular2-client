...
export class PaymentsWalletsApi {
     ...
     * 
     */
    public getWalletTotalsUsingGET(extraHttpRequestParams?: any): Observable<models.PageResourceWalletTotalResponse> {
     ...
     */
    public getWalletsUsingGET1(size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceSimpleWallet> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public transactionHistoryUsingGET(filterInvoice?: number, filterType?: string, filterMaxDate?: number, filterMinDate?: number, filterSign?: string, filterUserId?: number, filterUsername?: string, filterDetails?: string, filterCurrencyCode?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceWalletTransactionResource> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public userTransactionHistoryUsingGET(userId: number, currencyCode: string, filterType?: string, filterMaxDate?: number, filterMinDate?: number, filterSign?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceWalletTransactionResource> {
    ...
    public transactionHistoryUsingGETWithHttpInfo(filterInvoice?: number, filterType?: string, filterMaxDate?: number, filterMinDate?: number, filterSign?: string, filterUserId?: number, filterUsername?: string, filterDetails?: string, filterCurrencyCode?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (filterSign !== undefined) {
            if(filterSign instanceof Date) {
                queryParameters.set('filter_sign', <any>filterSign.d.toISOString());
            } else {
        ...
        if (filterUserId !== undefined) {
            if(filterUserId instanceof Date) {
                queryParameters.set('filter_user_id', <any>filterUserId.d.toISOString());
            } else {
        ...
        if (filterDetails !== undefined) {
            if(filterDetails instanceof Date) {
                queryParameters.set('filter_details', <any>filterDetails.d.toISOString());
            } else {
        ...
        if (filterCurrencyCode !== undefined) {
            if(filterCurrencyCode instanceof Date) {
                queryParameters.set('filter_currency_code', <any>filterCurrencyCode.d.toISOString());
            } else {
