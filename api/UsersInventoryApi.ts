...
export class UsersInventoryApi {
     ...
     */
    public getUserInventories(id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserInventoryResource> {
        return this.getUserInventoriesWithHttpInfo(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param filterMaxDate Filter for inventory added before the specified date, unix timestamp in seconds
     */
    public getUserInventoriesWithHttpInfo(id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/${id}/inventory`;
