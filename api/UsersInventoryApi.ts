...
export class UsersInventoryApi {
     ...
     */
    public createEntitlementItem(entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any): Observable<models.EntitlementItem> {
        return this.createEntitlementItemWithHttpInfo(entitlementItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public getUserInventory1(id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserInventoryResource> {
        return this.getUserInventory1WithHttpInfo(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public getUserInventoryLog1(userId: number, id: number, timestamp?: number, extraHttpRequestParams?: any): Observable<{}> {
        return this.getUserInventoryLog1WithHttpInfo(userId, id, timestamp, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public getUsersInventory(inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterUsername?: string, filterGroup?: string, filterDate?: string, extraHttpRequestParams?: any): Observable<models.PageResourceUserInventoryResource> {
        return this.getUsersInventoryWithHttpInfo(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param entitlementItem The entitlement item object
     */
    public updateEntitlementItem(entitlementId: number, entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateEntitlementItemWithHttpInfo(entitlementId, entitlementItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateEntitlementTemplate(id: string, template?: models.ItemTemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param entitlementItem The entitlement item object
     */
    public createEntitlementItemWithHttpInfo(entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param filterMaxDate Filter for inventory added before the specified date, unix timestamp in seconds
     */
    public getUserInventory1WithHttpInfo(id: number, inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterMinDate?: number, filterMaxDate?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/${id}/inventory`;
     ...
     * @param timestamp The new expiration date as a unix timestamp in seconds. May be null (no body).
     */
    public getUserInventoryLog1WithHttpInfo(userId: number, id: number, timestamp?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param filterDate A comma separated string without spaces.  First value is the operator to search on, second value is the log start date, a unix timestamp in seconds. Can be repeated for a range, eg: GT,123,LT,456  Allowed operators: (GT, LT, EQ, GOE, LOE).
     */
    public getUsersInventoryWithHttpInfo(inactive?: boolean, size?: number, page?: number, filterItemName?: string, filterUsername?: string, filterGroup?: string, filterDate?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param entitlementItem The entitlement item object
     */
    public updateEntitlementItemWithHttpInfo(entitlementId: number, entitlementItem?: models.EntitlementItem, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/entitlements/${entitlement_id}`;
