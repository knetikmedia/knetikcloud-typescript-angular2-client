...
export class UsersFriendshipsApi {
     ...
     */
    public getFriends(userId: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceSimpleUserResource> {
        return this.getFriendsWithHttpInfo(userId, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getInvites(userId: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceSimpleUserResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getFriendsWithHttpInfo(userId: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
