...
import { PageResourceBehaviorDefinitionResource } from '../model/pageResourceBehaviorDefinitionResource';
...
export class StoreService {
     ...
     */
    public getBehaviors(size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceBehaviorDefinitionResource> {
        return this.getBehaviorsWithHttpInfo(size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @summary One-step invoice creation
     * @param quickNewRequest Quick new details
     */
    public quickNew(quickNewRequest?: QuickPaidRequest, extraHttpRequestParams?: any): Observable<InvoiceResource> {
        return this.quickNewWithHttpInfo(quickNewRequest, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateItemTemplate(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<StoreItemTemplateResource> {
        return this.updateItemTemplateWithHttpInfo(id, templatePatchResource, testValidation, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getBehaviorsWithHttpInfo(size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param quickNewRequest Quick new details
     */
    public quickNewWithHttpInfo(quickNewRequest?: QuickPaidRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/store/quick-new';
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            method: RequestMethod.Post,
            headers: headers,
            body: quickNewRequest == null ? '' : JSON.stringify(quickNewRequest), // https://github.com/angular/angular/issues/10612
            search: queryParameters,
            withCredentials:this.configuration.withCredentials
        });
        // https://github.com/swagger-api/swagger-codegen/issues/4037
     ...
     * @param testValidation If true, this will test validation but not submit the patch request
     */
    public updateItemTemplateWithHttpInfo(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/store/items/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
