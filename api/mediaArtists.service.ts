...
export class MediaArtistsService {
     ...
     * @param artistTemplateResource The artist template resource object
     */
    public updateArtistTemplate(id: string, artistTemplateResource?: TemplateResource, extraHttpRequestParams?: any): Observable<TemplateResource> {
     ...
     * @param artistTemplateResource The artist template resource object
     */
    public updateArtistTemplateWithHttpInfo(id: string, artistTemplateResource?: TemplateResource, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/media/artists/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
