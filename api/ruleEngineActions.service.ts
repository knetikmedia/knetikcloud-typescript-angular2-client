...
import { PageResourceActionResource } from '../model/pageResourceActionResource';
...
export class RuleEngineActionsService {
     ...
     */
    public getBREActions(filterCategory?: string, filterName?: string, filterTags?: string, filterSearch?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceActionResource> {
        return this.getBREActionsWithHttpInfo(filterCategory, filterName, filterTags, filterSearch, size, page, extraHttpRequestParams)
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getBREActionsWithHttpInfo(filterCategory?: string, filterName?: string, filterTags?: string, filterSearch?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
