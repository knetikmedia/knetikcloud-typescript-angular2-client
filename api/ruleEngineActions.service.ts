...
export class RuleEngineActionsService {
     ...
     */
    public getBREActions(filterCategory?: string, filterName?: string, filterTags?: string, filterSearch?: string, extraHttpRequestParams?: any): Observable<Array<ActionResource>> {
        return this.getBREActionsWithHttpInfo(filterCategory, filterName, filterTags, filterSearch, extraHttpRequestParams)
     ...
     * @param filterSearch Filter for actions containing the given words somewhere within name, description and tags
     */
    public getBREActionsWithHttpInfo(filterCategory?: string, filterName?: string, filterTags?: string, filterSearch?: string, extraHttpRequestParams?: any): Observable<Response> {
