...
export class ReportingUsersApi {
     ...
     */
    public getUserRegistrations(granularity?: string, startDate?: number, endDate?: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceAggregateCountResource> {
