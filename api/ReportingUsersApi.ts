...
export class ReportingUsersApi {
     ...
     */
    public getUserRegistrations(granularity?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any): Observable<models.PageResourceAggregateCountResource> {
        return this.getUserRegistrationsWithHttpInfo(granularity, startDate, endDate, extraHttpRequestParams)
     ...
     * @param endDate The end of the time range to aggregate, unix timestamp in seconds. Default is end of time
     */
    public getUserRegistrationsWithHttpInfo(granularity?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any): Observable<Response> {
