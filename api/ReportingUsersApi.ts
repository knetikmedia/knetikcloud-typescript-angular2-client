...
export class ReportingUsersApi {
     ...
     */
    public executiveRevenueItemSalesUsingGET1(granularity?: string, startDate?: number, endDate?: number, extraHttpRequestParams?: any): Observable<models.PageAggregateCountResource> {
