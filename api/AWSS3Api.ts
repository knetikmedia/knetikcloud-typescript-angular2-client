...
export class AWSS3Api {
     ...
     */
    public preSignUrlUsingGET(filename?: string, contentType?: string, extraHttpRequestParams?: any): Observable<models.AmazonS3Activity> {
        return this.preSignUrlUsingGETWithHttpInfo(filename, contentType, extraHttpRequestParams)
     ...
     * @param contentType The content type
     */
    public preSignUrlUsingGETWithHttpInfo(filename?: string, contentType?: string, extraHttpRequestParams?: any): Observable<Response> {
