...
export class MediaVideosApi {
     ...
     */
    public deleteRelationshipUsingDELETE(videoId: number, id: number, extraHttpRequestParams?: any): Observable<{}> {
        return this.deleteRelationshipUsingDELETEWithHttpInfo(videoId, id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public getCommentsUsingGET1(videoId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageCommentResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getDispositionsUsingGET1(videoId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageDispositionResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getRelatedUsingGET(videoId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageVideoRelationshipResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserVideosUsingGET(userId: number, excludeFlagged?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageVideoResource> {
     ...
     */
    public searchVideosUsingGET(excludeFlagged?: boolean, filterVideosByUploader?: string, filterCategory?: string, filterTagset?: string, filterVideosByName?: string, filterVideosByContributor?: string, filterVideosByAuthor?: string, filterHasAuthor?: boolean, filterHasUploader?: boolean, filterRelatedTo?: string, filterFriends?: boolean, filterDisposition?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageVideoResource> {
     ...
     */
    public updateRelationshipUsingPUT(videoId: number, relationshipId: number, details?: string, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateRelationshipUsingPUTWithHttpInfo(videoId, relationshipId, details, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id The relationship id
     */
    public deleteRelationshipUsingDELETEWithHttpInfo(videoId: number, id: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param details The video relationship details
     */
    public updateRelationshipUsingPUTWithHttpInfo(videoId: number, relationshipId: number, details?: string, extraHttpRequestParams?: any): Observable<Response> {
