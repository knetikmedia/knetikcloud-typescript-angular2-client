...
export class GamificationAchievementsService {
     ...
     */
    public getDerivedAchievements(name: string, extraHttpRequestParams?: any): Observable<Array<AchievementDefinitionResource>> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserAchievementsProgress(userId: number, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceUserAchievementGroupResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementProgress(achievementName: string, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceUserAchievementGroupResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementsProgress(filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceUserAchievementGroupResource> {
     ...
     */
    public updateAchievementTemplate(id: string, template?: TemplateResource, extraHttpRequestParams?: any): Observable<TemplateResource> {
     ...
     * @param template The updated template
     */
    public updateAchievementTemplateWithHttpInfo(id: string, template?: TemplateResource, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/achievements/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
