...
export class LocationsApi {
     ...
     */
    public getCities(countryCodeIso3: string, stateCode: string, extraHttpRequestParams?: any): Observable<Array<models.CityResource>> {
        return this.getCitiesWithHttpInfo(countryCodeIso3, stateCode, extraHttpRequestParams)
     ...
     * 
     */
    public getCountries1(extraHttpRequestParams?: any): Observable<Array<models.CountryResource>> {
        return this.getCountries1WithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param countryCodeIso3 The iso3 code of the country
     */
    public getCountries2(countryCodeIso3: string, extraHttpRequestParams?: any): Observable<Array<models.StateResource>> {
        return this.getCountries2WithHttpInfo(countryCodeIso3, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param stateCode The code of the state
     */
    public getCitiesWithHttpInfo(countryCodeIso3: string, stateCode: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * 
     */
    public getCountries1WithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param countryCodeIso3 The iso3 code of the country
     */
    public getCountries2WithHttpInfo(countryCodeIso3: string, extraHttpRequestParams?: any): Observable<Response> {
