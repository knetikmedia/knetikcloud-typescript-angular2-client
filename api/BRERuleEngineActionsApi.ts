...
export class BRERuleEngineActionsApi {
     ...
     */
    public getBREActions(filterCategory?: string, filterName?: string, filterTags?: string, filterSearch?: string, extraHttpRequestParams?: any): Observable<Array<models.ActionResource>> {
