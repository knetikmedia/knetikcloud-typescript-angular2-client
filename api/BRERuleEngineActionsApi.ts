...
export class BRERuleEngineActionsApi {
     ...
     */
    public getBREActions(filterCategory?: string, filterName?: string, extraHttpRequestParams?: any): Observable<Array<models.ActionResource>> {
        return this.getBREActionsWithHttpInfo(filterCategory, filterName, extraHttpRequestParams)
     ...
     * @param filterName Filter for actions that have names containing the given string
     */
    public getBREActionsWithHttpInfo(filterCategory?: string, filterName?: string, extraHttpRequestParams?: any): Observable<Response> {
