...
export class GamificationAchievementsApi {
     ...
     */
    public getAchievementTemplatesUsingGET(size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceTemplateResource> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getAchievementsUsingGET(filterTagset?: string, filterName?: string, filterHidden?: boolean, filterDerived?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceAchievementDefinitionResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressForAchievementUsingGET(achievementName: string, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressUsingGET(filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserProgressUsingGET(userId: number, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
