...
export class GamificationAchievementsApi {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getAchievements(filterTagset?: string, filterName?: string, filterHidden?: boolean, filterDerived?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceAchievementDefinitionResource> {
        return this.getAchievementsWithHttpInfo(filterTagset, filterName, filterHidden, filterDerived, size, page, order, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserAchievementsProgress(userId: number, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
        return this.getUserAchievementsProgressWithHttpInfo(userId, filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementProgress(achievementName: string, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
        return this.getUsersAchievementProgressWithHttpInfo(achievementName, filterAchievementDerived, filterAchievementTagset, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementsProgress(filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceUserAchievementGroupResource> {
        return this.getUsersAchievementsProgressWithHttpInfo(filterAchievementDerived, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param achievement The achievement definition
     */
    public updateAchievement(name: string, achievement?: models.AchievementDefinitionResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     */
    public updateAchievementProgress(userId: number, achievementName: string, request?: models.AchievementProgressUpdateRequest, extraHttpRequestParams?: any): Observable<models.UserAchievementGroupResource> {
        return this.updateAchievementProgressWithHttpInfo(userId, achievementName, request, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateAchievementTemplate(id: string, template?: models.TemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getAchievementsWithHttpInfo(filterTagset?: string, filterName?: string, filterHidden?: boolean, filterDerived?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/achievements`;
        ...
        if (filterHidden !== undefined) {
            if(filterHidden instanceof Date) {
                queryParameters.set('filter_hidden', <any>filterHidden.d.toISOString());
            } else {
        ...
        if (filterDerived !== undefined) {
            if(filterDerived instanceof Date) {
                queryParameters.set('filter_derived', <any>filterDerived.d.toISOString());
            } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserAchievementsProgressWithHttpInfo(userId: number, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (filterAchievementDerived !== undefined) {
            if(filterAchievementDerived instanceof Date) {
                queryParameters.set('filter_achievement_derived', <any>filterAchievementDerived.d.toISOString());
            } else {
        ...
        if (filterAchievementTagset !== undefined) {
            if(filterAchievementTagset instanceof Date) {
                queryParameters.set('filter_achievement_tagset', <any>filterAchievementTagset.d.toISOString());
            } else {
        ...
        if (filterAchievementName !== undefined) {
            if(filterAchievementName instanceof Date) {
                queryParameters.set('filter_achievement_name', <any>filterAchievementName.d.toISOString());
            } else {
        ...
        if (filterAchievementHidden !== undefined) {
            if(filterAchievementHidden instanceof Date) {
                queryParameters.set('filter_achievement_hidden', <any>filterAchievementHidden.d.toISOString());
            } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementProgressWithHttpInfo(achievementName: string, filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUsersAchievementsProgressWithHttpInfo(filterAchievementDerived?: boolean, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param request The progress update details
     */
    public updateAchievementProgressWithHttpInfo(userId: number, achievementName: string, request?: models.AchievementProgressUpdateRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/${user_id}/achievements/${achievement_name}`;
