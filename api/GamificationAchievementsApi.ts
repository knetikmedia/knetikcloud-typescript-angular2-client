...
export class GamificationAchievementsApi {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getAchievementsUsingGET(filterTagset?: string, filterName?: string, filterHidden?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageAchievementDefinitionResource> {
        return this.getAchievementsUsingGETWithHttpInfo(filterTagset, filterName, filterHidden, size, page, order, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressForAchievementUsingGET(achievementName: string, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageUserAchievementResource> {
        return this.getAllUserProgressForAchievementUsingGETWithHttpInfo(achievementName, filterAchievementTagset, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressUsingGET(filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageUserAchievementResource> {
        return this.getAllUserProgressUsingGETWithHttpInfo(filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param achievementName The achievement&#39;s name
     */
    public getUserProgressForAchievementUsingGET(userId: number, achievementName: string, extraHttpRequestParams?: any): Observable<models.UserAchievementResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserProgressUsingGET(userId: number, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageUserAchievementResource> {
        return this.getUserProgressUsingGETWithHttpInfo(userId, filterAchievementTagset, filterAchievementName, filterAchievementHidden, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateProgressUsingPUT(userId: number, achievementName: string, request?: models.AchievementProgressUpdateRequest, extraHttpRequestParams?: any): Observable<models.UserAchievementResource> {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getAchievementsUsingGETWithHttpInfo(filterTagset?: string, filterName?: string, filterHidden?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/achievements`;
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressForAchievementUsingGETWithHttpInfo(achievementName: string, filterAchievementTagset?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getAllUserProgressUsingGETWithHttpInfo(filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserProgressUsingGETWithHttpInfo(userId: number, filterAchievementTagset?: string, filterAchievementName?: string, filterAchievementHidden?: boolean, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
