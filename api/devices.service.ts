...
export class DevicesService {
     ...
     * @param id id
     */
    public addDeviceUser(userResources: Array<SimpleUserResource>, id: string, extraHttpRequestParams?: any): Observable<DeviceResource> {
        return this.addDeviceUserWithHttpInfo(userResources, id, extraHttpRequestParams)
     ...
     */
    public updateDeviceTemplate(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<TemplateResource> {
        return this.updateDeviceTemplateWithHttpInfo(id, templatePatchResource, testValidation, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id id
     */
    public addDeviceUserWithHttpInfo(userResources: Array<SimpleUserResource>, id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (userResources === null || userResources === undefined) {
            throw new Error('Required parameter userResources was null or undefined when calling addDeviceUser.');
        }
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling addDeviceUser.');
        }
     ...
     * @param testValidation If true, this will test validation but not submit the patch request
     */
    public updateDeviceTemplateWithHttpInfo(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/devices/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
