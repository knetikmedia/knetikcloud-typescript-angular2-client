...
export class ContentCommentsApi {
     ...
     */
    public getCommentsUsingGET(context: string, contextId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceCommentResource> {
