...
export class UtilSecurityApi {
     ...
     */
    public getUserLocationLog(userId?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceLocationLogResource> {
        return this.getUserLocationLogWithHttpInfo(userId, size, page, order, extraHttpRequestParams)
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getUserLocationLogWithHttpInfo(userId?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
