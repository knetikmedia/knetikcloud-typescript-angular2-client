...
export class InvoicesApi {
     ...
     */
    public getInvoiceHistoryUsingGET(filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterCreatedDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceInvoiceResource> {
     ...
     */
    public getInvoiceUsingGET(id: number, extraHttpRequestParams?: any): Observable<models.InvoiceResource> {
        return this.getInvoiceUsingGETWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getLogsUsingGET(id: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceInvoiceLogEntry> {
     ...
     * @param id The id of the invoice
     */
    public getInvoiceUsingGETWithHttpInfo(id: number, extraHttpRequestParams?: any): Observable<Response> {
