...
export class InvoicesApi {
    ...
    public getInvoicesWithHttpInfo(filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterExternalRef?: string, filterCreatedDate?: string, filterVendorIds?: string, filterCurrency?: string, filterShippingStateName?: string, filterShippingCountryName?: string, filterShipping?: number, filterVendorName?: string, filterSku?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (filterVendorIds !== undefined) {
            if(filterVendorIds instanceof Date) {
                queryParameters.set('filter_vendor_ids', <any>filterVendorIds.d.toISOString());
            } else {
        ...
        if (filterCurrency !== undefined) {
            if(filterCurrency instanceof Date) {
                queryParameters.set('filter_currency', <any>filterCurrency.d.toISOString());
            } else {
        ...
        if (filterShippingStateName !== undefined) {
            if(filterShippingStateName instanceof Date) {
                queryParameters.set('filter_shipping_state_name', <any>filterShippingStateName.d.toISOString());
            } else {
        ...
        if (filterShippingCountryName !== undefined) {
            if(filterShippingCountryName instanceof Date) {
                queryParameters.set('filter_shipping_country_name', <any>filterShippingCountryName.d.toISOString());
            } else {
        ...
        if (filterShipping !== undefined) {
            if(filterShipping instanceof Date) {
                queryParameters.set('filter_shipping', <any>filterShipping.d.toISOString());
            } else {
        ...
        if (filterVendorName !== undefined) {
            if(filterVendorName instanceof Date) {
                queryParameters.set('filter_vendor_name', <any>filterVendorName.d.toISOString());
            } else {
