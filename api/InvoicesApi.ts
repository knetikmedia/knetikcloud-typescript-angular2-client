...
export class InvoicesApi {
     ...
     */
    public getInvoices(filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterCreatedDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceInvoiceResource> {
        return this.getInvoicesWithHttpInfo(filterUser, filterEmail, filterFulfillmentStatus, filterPaymentStatus, filterItemName, filterCreatedDate, size, page, order, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * 
     */
    public listFulFillmentStatuses(extraHttpRequestParams?: any): Observable<Array<string>> {
        return this.listFulFillmentStatusesWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * 
     */
    public listPaymentStatuses(extraHttpRequestParams?: any): Observable<Array<string>> {
        return this.listPaymentStatusesWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getInvoicesWithHttpInfo(filterUser?: number, filterEmail?: string, filterFulfillmentStatus?: string, filterPaymentStatus?: string, filterItemName?: string, filterCreatedDate?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/invoices`;
        ...
        if (filterCreatedDate !== undefined) {
            if(filterCreatedDate instanceof Date) {
                queryParameters.set('filter_created_date', <any>filterCreatedDate.d.toISOString());
            } else {
     ...
     * 
     */
    public listFulFillmentStatusesWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
     ...
     * 
     */
    public listPaymentStatusesWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
