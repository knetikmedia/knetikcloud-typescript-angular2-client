...
import { PageResourceExpressionResource } from '../model/pageResourceExpressionResource';
...
export class RuleEngineExpressionsService {
     ...
     */
    public getBREExpressions(filterTypeGroup?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceExpressionResource> {
        return this.getBREExpressionsWithHttpInfo(filterTypeGroup, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getBREExpressionsWithHttpInfo(filterTypeGroup?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
