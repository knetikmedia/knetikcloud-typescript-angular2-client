...
export class UsersService {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserTags(userId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourcestring> {
        return this.getUserTagsWithHttpInfo(userId, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateUserTemplate(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<TemplateResource> {
        return this.updateUserTemplateWithHttpInfo(id, templatePatchResource, testValidation, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getUserTagsWithHttpInfo(userId: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/users/${user_id}/tags'
                    .replace('${' + 'user_id' + '}', String(userId));
     ...
     * @param testValidation If true, this will test validation but not submit the patch request
     */
    public updateUserTemplateWithHttpInfo(id: string, templatePatchResource?: PatchResource, testValidation?: boolean, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/users/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
