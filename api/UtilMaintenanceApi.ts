...
export class UtilMaintenanceApi {
     ...
     * @param maintenance The maintenance object
     */
    public updateMaintenance1(maintenance?: models.Maintenance, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateMaintenance1WithHttpInfo(maintenance, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param maintenance The maintenance object
     */
    public updateMaintenance1WithHttpInfo(maintenance?: models.Maintenance, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/maintenance`;
