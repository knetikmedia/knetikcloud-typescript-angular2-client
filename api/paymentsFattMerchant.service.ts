...
export class PaymentsFattMerchantService {
     ...
     */
    public createOrUpdateFattMerchantPaymentMethod(request?: FattMerchantPaymentMethodRequest, extraHttpRequestParams?: any): Observable<PaymentMethodResource> {
        return this.createOrUpdateFattMerchantPaymentMethodWithHttpInfo(request, extraHttpRequestParams)
    ...
    public createOrUpdateFattMerchantPaymentMethodWithHttpInfo(request?: FattMerchantPaymentMethodRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/payment/provider/fattmerchant/payment-methods';
