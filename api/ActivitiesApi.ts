...
export class ActivitiesApi {
     ...
     */
    public getActivitiesUsingGET(filterTemplate?: boolean, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageBareActivityResource> {
