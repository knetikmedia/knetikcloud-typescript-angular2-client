...
import { PageResourceAccessResultsResource } from '../model/pageResourceAccessResultsResource';
...
export class AuthTypesService {
     ...
     */
    public allowedResourceActions(type: string, id: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceAccessResultsResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public allowedTypeActions(type: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceAccessResultsResource> {
     ...
     * @param type The type value
     */
    public deleteAllOfType(type: string, extraHttpRequestParams?: any): Observable<{}> {
        return this.deleteAllOfTypeWithHttpInfo(type, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param type The type value
     */
    public deleteAllOfTypeWithHttpInfo(type: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/access/resources/${type}'
                    .replace('${' + 'type' + '}', String(type));
        ...
        // verify required parameter 'type' is not null or undefined
        if (type === null || type === undefined) {
            throw new Error('Required parameter type was null or undefined when calling deleteAllOfType.');
        }
