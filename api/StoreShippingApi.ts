...
export class StoreShippingApi {
     ...
     */
    public createShippingItem(shippingItem?: models.ShippingItem, extraHttpRequestParams?: any): Observable<models.ShippingItem> {
        return this.createShippingItemWithHttpInfo(shippingItem, extraHttpRequestParams)
     ...
     * @param shippingItem The shipping item object
     */
    public updateShippingItem(id: number, shippingItem?: models.ShippingItem, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateShippingItemWithHttpInfo(id, shippingItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateShippingTemplate(id: string, shippingTemplateResource?: models.ItemTemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param shippingItem The shipping item object
     */
    public createShippingItemWithHttpInfo(shippingItem?: models.ShippingItem, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param shippingItem The shipping item object
     */
    public updateShippingItemWithHttpInfo(id: number, shippingItem?: models.ShippingItem, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/store/shipping/${id}`;
