...
export class AuthRolesApi {
     ...
     */
    public setClientRoles(clientKey: string, rolesList?: Array<string>, extraHttpRequestParams?: any): Observable<{}> {
     ...
     */
    public setPermissionsForRole(role: string, permissionsList?: Array<string>, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param rolesList The list of unique roles
     */
    public setUserRoles(userId: number, rolesList?: Array<string>, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param roleResource The role resource object
     */
    public updateRole(role: string, roleResource?: models.RoleResource, extraHttpRequestParams?: any): Observable<{}> {
