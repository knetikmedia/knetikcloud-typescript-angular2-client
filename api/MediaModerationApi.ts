...
export class MediaModerationApi {
     ...
     */
    public getFlagsReportUsingGET(excludeResolved?: boolean, filterContext?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageResourceFlagReportResource> {
