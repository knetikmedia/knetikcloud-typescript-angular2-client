...
export class UsersRelationshipsService {
     ...
     * @param id The id of the relationship
     */
    public getRelationship(id: number, extraHttpRequestParams?: any): Observable<UserRelationshipResource> {
        return this.getRelationshipWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id The id of the relationship
     */
    public getRelationshipWithHttpInfo(id: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/users/relationships/${id}'
                    .replace('${' + 'id' + '}', String(id));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getRelationship.');
        }
