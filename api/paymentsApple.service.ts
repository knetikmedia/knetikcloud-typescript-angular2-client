...
export class PaymentsAppleService {
     ...
     */
    public verifyAppleReceipt(request?: ApplyPaymentRequest, extraHttpRequestParams?: any): Observable<StringWrapper> {
        return this.verifyAppleReceiptWithHttpInfo(request, extraHttpRequestParams)
     ...
     * @param request The request for paying an invoice through an Apple receipt
     */
    public verifyAppleReceiptWithHttpInfo(request?: ApplyPaymentRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/payment/provider/apple/receipt';
