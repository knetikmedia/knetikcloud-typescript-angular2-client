...
export class CampaignsChallengesApi {
     ...
     */
    public getActivitiesUsingGET1(challengeId: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageBareChallengeActivityResource> {
     ...
     * 
     * @param filterStartDateMin events starting after this date, unix timestamp in seconds
     * @param filterStartDateMax events starting before this date, unix timestamp in seconds
     * @param filterEndDateMin events ending after this date, unix timestamp in seconds
     * @param filterEndDateMax events ending before this date, unix timestamp in seconds
     ...
     * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getChallengeEventssUsingGET(filterStartDateMin?: number, filterStartDateMax?: number, filterEndDateMin?: number, filterEndDateMax?: number, filterCampaigns?: boolean, filterChallenge?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageChallengeEventResource> {
        return this.getChallengeEventssUsingGETWithHttpInfo(filterStartDateMin, filterStartDateMax, filterEndDateMin, filterEndDateMax, filterCampaigns, filterChallenge, size, page, order, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getChallengeTemplatesUsingGET(size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageTemplateResource> {
     ...
     */
    public getChallengesUsingGET1(filterTemplate?: boolean, filterActiveCampaign?: boolean, extraHttpRequestParams?: any): Observable<models.PageChallengeResource> {
     ...
     * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public getChallengeEventssUsingGETWithHttpInfo(filterStartDateMin?: number, filterStartDateMax?: number, filterEndDateMin?: number, filterEndDateMax?: number, filterCampaigns?: boolean, filterChallenge?: number, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/challenges/events`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        if (filterStartDateMin !== undefined) {
            queryParameters.set('filter_start_date_min', <any>filterStartDateMin);
        }
        if (filterStartDateMax !== undefined) {
            queryParameters.set('filter_start_date_max', <any>filterStartDateMax);
        }
        if (filterEndDateMin !== undefined) {
            queryParameters.set('filter_end_date_min', <any>filterEndDateMin);
        }
        if (filterEndDateMax !== undefined) {
            queryParameters.set('filter_end_date_max', <any>filterEndDateMax);
        }
