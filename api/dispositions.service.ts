...
import { PageResourceDispositionCount } from '../model/pageResourceDispositionCount';
...
export class DispositionsService {
     ...
     */
    public getDispositionCounts(filterCreatedDate?: string, filterContext?: string, filterOwner?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<PageResourceDispositionCount> {
        return this.getDispositionCountsWithHttpInfo(filterCreatedDate, filterContext, filterOwner, size, page, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public getDispositionCountsWithHttpInfo(filterCreatedDate?: string, filterContext?: string, filterOwner?: string, size?: number, page?: number, extraHttpRequestParams?: any): Observable<Response> {
