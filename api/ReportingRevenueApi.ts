...
export class ReportingRevenueApi {
     ...
     */
    public executiveRevenueCountrySalesUsingGET(currencyCode: string, startDate?: number, endDate?: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageRevenueCountryReportResource> {
     ...
     * @param page The number of the page returned, starting with 1
     */
    public executiveRevenueProductSalesUsingGET(currencyCode: string, startDate?: number, endDate?: number, size?: number, page?: number, extraHttpRequestParams?: any): Observable<models.PageRevenueProductReportResource> {
