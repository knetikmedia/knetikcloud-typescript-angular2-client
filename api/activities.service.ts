...
export class ActivitiesService {
     ...
     * @param activityTemplateResource The activity template resource object
     */
    public updateActivityTemplate(id: string, activityTemplateResource?: TemplateResource, extraHttpRequestParams?: any): Observable<TemplateResource> {
     ...
     * @param activityTemplateResource The activity template resource object
     */
    public updateActivityTemplateWithHttpInfo(id: string, activityTemplateResource?: TemplateResource, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/activities/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
