...
export class UsersInventoryService {
     ...
     */
    public updateEntitlementTemplate(id: string, template?: ItemTemplateResource, extraHttpRequestParams?: any): Observable<ItemTemplateResource> {
     ...
     * @param template The updated template
     */
    public updateEntitlementTemplateWithHttpInfo(id: string, template?: ItemTemplateResource, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/entitlements/templates/${id}'
                    .replace('${' + 'id' + '}', String(id));
