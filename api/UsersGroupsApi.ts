...
export class UsersGroupsApi {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public updateGroups(filterName?: string, filterUniqueName?: string, filterParent?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<models.PageResourceGroupResource> {
        return this.updateGroupsWithHttpInfo(filterName, filterUniqueName, filterParent, size, page, order, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]
     */
    public updateGroupsWithHttpInfo(filterName?: string, filterUniqueName?: string, filterParent?: string, size?: number, page?: number, order?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/users/groups';
