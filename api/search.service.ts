...
export class SearchService {
     ...
     */
    public reindexAll(request: ReindexRequest, extraHttpRequestParams?: any): Observable<{}> {
        return this.reindexAllWithHttpInfo(request, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param request request
     */
    public reindexAllWithHttpInfo(request: ReindexRequest, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling reindexAll.');
        }
