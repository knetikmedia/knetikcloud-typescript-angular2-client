...
export class StoreApi {
     ...
     */
    public createStoreItem(storeItem?: models.StoreItem, extraHttpRequestParams?: any): Observable<models.StoreItem> {
        return this.createStoreItemWithHttpInfo(storeItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public updateItemTemplate(id: string, itemTemplateResource?: models.StoreItemTemplateResource, extraHttpRequestParams?: any): Observable<{}> {
     ...
     * @param storeItem The store item object
     */
    public updateStoreItem(id: number, storeItem?: models.StoreItem, extraHttpRequestParams?: any): Observable<{}> {
        return this.updateStoreItemWithHttpInfo(id, storeItem, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param storeItem The store item object
     */
    public createStoreItemWithHttpInfo(storeItem?: models.StoreItem, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param storeItem The store item object
     */
    public updateStoreItemWithHttpInfo(id: number, storeItem?: models.StoreItem, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/store/items/${id}`;
