...
export class StoreApi {
     ...
     */
    public getUsingGET2(limit?: number, page?: number, useCatalog?: boolean, ignoreLocation?: boolean, inStockOnly?: boolean, extraHttpRequestParams?: any): Observable<models.PageResourceStoreItem> {
        return this.getUsingGET2WithHttpInfo(limit, page, useCatalog, ignoreLocation, inStockOnly, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param inStockOnly Whether only in-stock items should be returned.  Default value is false
     */
    public getUsingGET2WithHttpInfo(limit?: number, page?: number, useCatalog?: boolean, ignoreLocation?: boolean, inStockOnly?: boolean, extraHttpRequestParams?: any): Observable<Response> {
